...
var v1SubscriptionsPreview = requestflag.WithInnerFlags(cli.Command{
	...
	Flags: []cli.Flag{
		...
		&requestflag.Flag[string]{
			...
			Usage:    `Country code selecting a localized price, or "eu" for the European Union group you map countries into; the default price applies when none matches`,
...
var v1SubscriptionsProvision = requestflag.WithInnerFlags(cli.Command{
	...
	Flags: []cli.Flag{
		...
		&requestflag.Flag[*string]{
			Name:     "billing-country-code",
			Usage:    `The country code used to select a localized price, or "eu" for the European Union group you map countries into, falling back to the default price when none matches`,
			BodyPath: "billingCountryCode",
		},
		&requestflag.Flag[string]{
			Name:     "billing-cycle-anchor",
	...
	"price-override": {
		...
		&requestflag.InnerFlag[string]{
			...
			Usage:      `ISO 3166-1 alpha-2 country code this price applies to, or "eu" for the European Union group you map countries into. Omit for the default price shown to all countries; set one or more country-specific price periods on the same currency to localize the amount by billing country.`,
