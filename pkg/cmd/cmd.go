...
import (
	...
	"github.com/stiggio/stigg-cli/internal/autocomplete"
...
func init() {
	Command = &cli.Command{
		...
		Commands: []*cli.Command{
			...
			{
				Name:     "v1:credits:grants",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&v1CreditsGrantsCreate,
					&v1CreditsGrantsList,
					&v1CreditsGrantsVoid,
				},
			},
			{
				Name:     "v1:credits:custom-currencies",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&v1CreditsCustomCurrenciesCreate,
					&v1CreditsCustomCurrenciesUpdate,
					&v1CreditsCustomCurrenciesList,
			...
			{
				Name:     "v1:credits:auto-recharge",
				Category: "API RESOURCE",
				Suggest:  true,
				Commands: []*cli.Command{
					&v1CreditsAutoRechargeGetAutoRecharge,
				},
			},
			{
				Name:     "v1:features",
