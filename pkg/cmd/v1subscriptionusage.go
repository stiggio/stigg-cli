...
var v1SubscriptionsUsageChargeUsage = cli.Command{
	Name:    "charge-usage",
	Usage:   "Immediately charges usage for a subscription via the billing integration.\nCalculates usage since the last charge and creates an invoice.",
	Suggest: true,
	Flags: []cli.Flag{
...
var v1SubscriptionsUsageSync = cli.Command{
	Name:    "sync",
	Usage:   "Triggers a usage sync for a subscription, reporting current usage to the billing\nprovider.",
	Suggest: true,
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:     "id",
...
func handleV1SubscriptionsUsageChargeUsage(ctx context.Context, cmd *cli.Command) error {
