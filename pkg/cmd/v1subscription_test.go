...
func TestV1SubscriptionsUpdate(t *testing.T) {
	...
	mocktest.TestRunMockTestWithFlags(
		...
		"--id", "x",
		"--addon", "{addonId: addonId, quantity: 0}",
		...
		"--price-override", "{addonId: addonId, baseCharge: true, currencyId: currencyId, featureId: featureId, price: {amount: 0, currency: usd}}",
	...
	mocktest.TestRunMockTestWithFlags(
		...
		"--price-override.price", "{amount: 0, currency: usd}",
		"--promotion-code", "promotionCode",
		"--schedule-strategy", "END_OF_BILLING_PERIOD",
...
func TestV1SubscriptionsImport(t *testing.T) {
	...
	mocktest.TestRunMockTestWithFlags(
		...
		"--subscription", "{id: id, customerId: customerId, planId: planId, billingId: billingId, endDate: '2019-12-27T18:11:19.117Z', metadata: {foo: string}, resourceId: resourceId, startDate: '2019-12-27T18:11:19.117Z'}",
...
func TestV1SubscriptionsPreview(t *testing.T) {
	...
	mocktest.TestRunMockTestWithFlags(
		...
		"--customer-id", "customerId",
		"--plan-id", "planId",
		"--addon", "{addonId: addonId, quantity: 1}",
		"--applied-coupon", "{billingCouponId: billingCouponId, configuration: {startDate: '2019-12-27T18:11:19.117Z'}, couponId: couponId, discount: {amountsOff: [{amount: 0, currency: usd}], description: description, durationInMonths: 1, name: name, percentOff: 1}, promotionCode: promotionCode}",
...
func TestV1SubscriptionsProvision(t *testing.T) {
	...
	mocktest.TestRunMockTestWithFlags(
		...
		"--metadata", "{foo: string}",
		"--minimum-spend", "{minimum: {amount: 0, billingCountryCode: billingCountryCode, currency: usd}}",
		"--paying-customer-id", "payingCustomerId",
		"--payment-collection-method", "CHARGE",
		"--price-override", "{addonId: addonId, baseCharge: true, blockSize: 0, creditGrantCadence: BEGINNING_OF_BILLING_PERIOD, creditRate: {amount: 1, currencyId: currencyId, costFormula: costFormula}, featureId: featureId, price: {amount: 0, billingCountryCode: billingCountryCode, currency: usd}, tiers: [{flatPrice: {amount: 0, billingCountryCode: billingCountryCode, currency: usd}, unitPrice: {amount: 0, billingCountryCode: billingCountryCode, currency: usd}, upTo: 0}]}",
		"--resource-id", "resourceId",
	...
	mocktest.TestRunMockTestWithFlags(
		...
		"--price-override.feature-id", "featureId",
		"--price-override.price", "{amount: 0, billingCountryCode: billingCountryCode, currency: usd}",
		"--price-override.tiers", "[{flatPrice: {amount: 0, billingCountryCode: billingCountryCode, currency: usd}, unitPrice: {amount: 0, billingCountryCode: billingCountryCode, currency: usd}, upTo: 0}]",
		"--resource-id", "resourceId",
		"--salesforce-id", "salesforceId",
		"--schedule-strategy", "END_OF_BILLING_PERIOD",
		"--start-date", "2019-12-27T18:11:19.117Z",
