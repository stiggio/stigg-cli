...
var v1SubscriptionsFutureUpdateCancelPendingPayment = cli.Command{
	Name:    "cancel-pending-payment",
	Usage:   "Cancels a subscription update that is pending payment completion.",
	Suggest: true,
	Flags: []cli.Flag{
...
var v1SubscriptionsFutureUpdateCancelSchedule = cli.Command{
	Name:    "cancel-schedule",
	Usage:   "Cancels a scheduled subscription update, such as a future downgrade or plan\nchange.",
	Suggest: true,
	Flags: []cli.Flag{
		&requestflag.Flag[string]{
			Name:     "id",
...
func handleV1SubscriptionsFutureUpdateCancelPendingPayment(ctx context.Context, cmd *cli.Command) error {
